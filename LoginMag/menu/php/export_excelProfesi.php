...
$filename = "profesionales_" . date('Ymd') . ".csv";
...
fputcsv($output, array('ID', 'Nombre', 'Apellidos', 'Especialización', 'Email', 'Teléfono', 'Dirección', 'Estado'), ';');

// Escribir los datos de los profesionales
