...
$query = "UPDATE public.profesionales
          SET nombre='$nombre', apellidos='$apellidos', especializacion='$especializacion', email='$email',telefono='$telefono',direccion='$direccion'
          WHERE id=$id";
